...
public:
    ...
    static ErrorCode unserialize(const std::string& urlSafeStr, EncryptionParams& result);
...
private:
    static bool finishInternal(EVP_CIPHER_CTX* ctx, EncryptionType type, const std::string& tag);
};
}
}  // End of namespaces
