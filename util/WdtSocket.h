...
class WdtSocket {
public:
    WdtSocket(ThreadCtx &threadCtx, int port, const EncryptionParams &encryptionParams, int64_t ivChangeInterval, Func &&tagVerificationSuccessCallback);
...
protected:
     ...
     */
    static bool getNameInfo(const struct sockaddr *sa, socklen_t salen, std::string &host, std::string &port);
